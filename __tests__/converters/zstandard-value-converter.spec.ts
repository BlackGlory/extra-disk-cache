import { ZstandardValueConverter, ZstandardValueAsyncConverter } from '@converters/zstandard-value-converter'
...
describe('ZstandardValueAsyncConvertter', () => {
  test('toBuffer & fromBuffer', async () => {
    const converter = await ZstandardValueAsyncConverter.create(
